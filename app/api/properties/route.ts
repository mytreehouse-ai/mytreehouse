...
const InsertPropertySchema = z.object({
  ...
  floor_area: z.number().min(0).nullable(),
  lot_area: z.number().min(0).nullable(),
  sqm: z.number().min(0).nullable(),
  bedroom: z.number().min(0).nullable(),
  bathroom: z.number().min(0).nullable(),
  parking_lot: z.number().min(0).nullable(),
